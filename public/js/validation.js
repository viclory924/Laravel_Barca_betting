 var input= jQuery(".no-comma");
     jQuery(input).keydown(function (e) {
        if(e.keyCode == 188){
            e.preventDefault();
			var field_error = '<div class="field-error"><div class="align-m"><p>Please avoid use of commas</p></div></div>';
			$(field_error).insertAfter(this);
			
        }
     });
	 
 var input= jQuery(".no-space");
     jQuery(input).keydown(function (e) {
        if(e.keyCode == 32){
            e.preventDefault();
			var field_error = '<div class="field-error"><div class="align-m"><p>Please avoid use of space for this information.</p></div></div>';
			$(field_error).insertAfter(this);
...
$('#change-password-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax('/update-password', {
                    data: {
                        _token: $('input[name="_token"]').val(),
                        new_password: $('input[name="edit_new_password"]').val()
                    },
                    dataType: 'json',
                    method: 'post',
                    success: function(data, status, xhr) {
