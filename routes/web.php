...
Route::get('/', 'HomeController@selectLanguage')->name('home');
...
Route::post('/player/get-pending-withdrawals', 'PlayerController@getWithdrawals');
Route::post('/player/cancel-pending-withdraw', 'PlayerController@cancelPendingWithdraw');
...
Route::get('/sport', 'HomeController@sport')->name('sport');
...
Route::post('/add-bank-account', 'PlayerController@addBankAccount');
Route::post('/get-bank-account', 'PlayerController@getBankAccount');
Route::post('/get-bonuses', 'PlayerController@getBonuses');
//Route::post('/withdraw', 'PlayerController@makeWithdraw');
