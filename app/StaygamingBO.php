...
//        dd($result);
	...
	public static function getWithdrawTransactions($player_id) {
	    $url = 'api/v1/player/get-withdraw-transactions';
    ...
    public static function cancelPendingWithdrawTransactions(Request $request) {
        $url = 'api/v1/player/cancel-pending-withdraw-transaction';
    ...
    public static function addBankAccount($request, $player_id) {
	    $url = 'api/v1/player/add-bank-account';

	    $params = array(
	        'player_id' => $player_id,
            'bic_code' => $request->bic_code,
            'receiving_bank_name' => $request->receiving_bank_name,
            'receiving_bank_address' => $request->receiving_bank_address,
    ...
    public static function getBankAccount($player_id) {
	    $url = 'api/v1/player/get-bank-account';
    ...
    public static function getBonuses($player_id) {
	    $url = 'api/v1/player/get-bonuses';
